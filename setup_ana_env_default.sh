...
#export SMI_INPUT=/nevis/tehanu/home/ryshang/download
...
#export SMI_RUNLIST=/nevis/tehanu/home/ryshang/veritas_analysis/another-matrix-method/output_vts_query_bihan
...
export SMI_OUTPUT=/nevis/ged/data/rshang/smi_output/output_mtx_paper
#export SMI_RUNLIST=/nevis/tehanu/home/ryshang/veritas_analysis/another-matrix-method/output_vts_query_20241228
...
#export SMI_RUNLIST=/nevis/tehanu/home/ryshang/veritas_analysis/another-matrix-method/output_vts_query_20250421
#export SMI_OUTPUT=/nevis/ged/data/rshang/smi_output/output_20250421
...
#export BATCH_TAG="0hr"
export BATCH_TAG="5hr"

export SKY_TAG=$CR_TAG"_"$BIN_TAG"_"$EIGEN_TAG"_"$NORM_TAG"_"$BATCH_TAG
